...
from data_models.firestore_models.event import Event, EventCategory, EventSeverity, EventStatus, Source
...
class ProcessWithAITest(BaseBeamTest):
    ...
    def test_process_with_ai_success(self, mock_session, mock_storage_client, mock_generative_model):
        ...
        mock_generative_model.return_value.generate_content_async.return_value = mock_ai_response
