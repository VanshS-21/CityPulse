...
from server.data_models.data_ingestion.iot_pipeline import IotPipeline, IotPipelineOptions
...
def run_iot_pipeline():
    ...
    pipeline_options = PipelineOptions([
        ...
        '--schema_path=server/data_models/schemas/event_schema.json',  # Path to the schema file
    ])
