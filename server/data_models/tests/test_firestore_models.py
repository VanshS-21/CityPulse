...
def test_user_profile_model():
    ...
    # Test deserialization with doc_id
    new_profile = UserProfile(id="user123", **profile.model_dump(exclude={"id"}))
...
def test_firestore_repository_get_document_not_found(
    firestore_repository, mock_firestore
):
...
def test_firestore_repository_add_document_with_id(
    firestore_repository, mock_firestore
):
